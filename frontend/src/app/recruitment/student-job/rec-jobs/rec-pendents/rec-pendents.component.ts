...
@Component({
    selector: 'app-rec-pendents',
  templateUrl: './rec-pendents.component.html',
  styleUrls: ['./rec-pendents.component.scss']
})
export class RecPendentsComponent extends NotificationClass implements OnInit {
  ...
  public AcceptCandidate() {
    this.notify('Canditatura aceita com sucesso');
    const accept = this.acceptCandidate = false;
    console.log(accept);
  }
}
