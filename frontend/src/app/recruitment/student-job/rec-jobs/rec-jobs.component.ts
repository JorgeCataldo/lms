...
import { UserJobApplication, JobPositionPriorityEnum, JobPosition } from 'src/app/models/previews/user-job-application.interface';
import { RecruitingCompanyService } from '../../_services/recruiting-company.service';

@Component({
  selector: 'app-rec-jobs',
  templateUrl: './rec-jobs.component.html',
  styleUrls: ['./rec-jobs.component.scss']
})
export class RecJobsComponent extends NotificationClass implements OnInit {
