...
@Component({
  selector: 'app-top-bottom-talents-dialog',
  template: `
    <div class="concepts" >
      <ul>
  ...
  styleUrls: ['./top-bottom-talents.dialog.scss']
})
export class TrackOverviewTopBottomTalentsDialogComponent {

  constructor(
    public dialogRef: MatDialogRef<TrackOverviewTopBottomTalentsDialogComponent>,
