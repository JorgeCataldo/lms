...
@Component({
  ...
  templateUrl: './commitment-and-performance.component.html',
  styleUrls: ['./commitment-and-performance.component.scss']
})
export class CommitmentAndPerformanceComponent extends NotificationClass implements OnInit {
