...
@Component({
  selector: 'app-settings-profile-tests',
  templateUrl: './profile-tests.component.html',
  styleUrls: ['./profile-tests.component.scss']
})
export class ProfileTestsComponent extends NotificationClass implements OnInit {
