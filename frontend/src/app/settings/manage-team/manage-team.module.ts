...
import { SettingsCustomEmailComponent } from '../custom-email/custom-email.component';
...
import { ManageTeamFiltersModule } from './filters/filters.module';

@NgModule({
  declarations: [
    SettingsManageTeamComponent,
...
export class SettingsManageTeamModule { }
