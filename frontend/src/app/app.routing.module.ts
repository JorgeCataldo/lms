...
import { TrackStudentReportCardComponent } from './settings/tracks/track-overview/student-report-card/student-report-card.component';
...
const appRoutes: Routes = [
  ...
  /* Settings */ {
    ...
    path: 'configuracoes/trilha-de-curso/boletim/:trackId/:studentId', component: TrackStudentReportCardComponent,
    data: { page: 'settings-track-student-overview' }, canActivate: [ AuthGuard ]
  }, {
