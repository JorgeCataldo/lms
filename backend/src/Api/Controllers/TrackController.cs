...
namespace Api.Controllers
{
    ...
    public class TrackController: BaseController
    {
        ...
        [HttpGet("overview/getTrackBusinessManagerOverviewQuery")]
        public async Task<IActionResult> GetTrackBusinessManagerOverviewQuery(GetTrackStudentOverviewQuery.Contract request)
        {
        ...
        [HttpGet("reportCard/student")]
        public async Task<IActionResult> GetTrackStudentReportCard(GetTrackStudentReportCardQuery.Contract request)
        {
