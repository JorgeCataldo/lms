...
namespace Domain.Auth
{
    ...
    public class Response
    {
        ...
        public bool IsValid()
        {
            ...
            //Comentado até que seja descoberto como fazer a atualização do certificado automaticamente.
        ...
        public string IsValidText()
        {
            ...
            if (nodeList.Count == 0) return "No Nodes";

            signedXml.LoadXml((XmlElement)nodeList[0]);
            return $"ValidateSignatureReference: {ValidateSignatureReference(signedXml)} - CheckSignature: {signedXml.CheckSignature(_certificate.cert, true)} - IsExpired: {IsExpired()}";
        }
        ...
        public string GetEmail()
        {
            ...
            if (node == null)
                node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name']/saml:AttributeValue", _xmlNameSpaceManager);
